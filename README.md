...
```
- run `src/main/resources/post-schemes.sql`
...
##### <a id="albumcreate">Create com.reworked.album.Album -> /api/albums</a>
```json
{
...
##### <a id="albumupdate">Update com.reworked.album.Album -> /api/albums/{id}</a>
```json
{
