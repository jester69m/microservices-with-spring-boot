...
import com.reworked.category.CategoryRepository;
...
import static com.reworked.utils.AppConstants.*;
...
//	@Override
//	public Post updatePost(Long id, PostRequest newPostRequest, Long currentUser) {
...
//	@Override
//	public ApiResponse deletePost(Long id, Long currentUser) {
//		Post post = postRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException(POST, ID, id));
//		if (post.getUser().getId().equals(currentUser.getId())
//				|| currentUser.getAuthorities().contains(new SimpleGrantedAuthority(RoleName.ROLE_ADMIN.toString()))) {
...
//	@Override
//	public PostResponse addPost(PostRequest postRequest, Long currentUser) {
